...
typedef int (*PyGC_ThreadChecker)(void);
PyAPI_DATA(PyGC_ThreadChecker) PyGC_CheckThread;

#ifdef Py_DEBUG_GIL
PyAPI_FUNC(Py_ssize_t) PyGILState_Check();
#define _Py_GIL_CHECK       PyGILState_Check()
#define _Py_GIL_DEBUG_COMMA ,
#else
#define _Py_GIL_CHECK
#define _Py_GIL_DEBUG_COMMA
#endif

#define Py_INCREF(op) (                         \
    _Py_GIL_CHECK  _Py_GIL_DEBUG_COMMA          \
    _Py_INC_REFTOTAL  _Py_REF_DEBUG_COMMA       \
    ((PyObject*)(op))->ob_refcnt++)

#define Py_DECREF(op)                                   \
    do {                                                \
        if (_Py_GIL_CHECK  _Py_GIL_DEBUG_COMMA          \
