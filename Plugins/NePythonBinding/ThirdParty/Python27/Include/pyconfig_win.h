...
#ifdef _WIN32_WINNT
#define Py_WINVER _WIN32_WINNT
#else
#define Py_WINVER _WIN32_WINNT_WINXP
#endif
#ifdef _WIN32_WINNT
#define Py_NTDDI NTDDI_VERSION_FROM_WIN32_WINNT(_WIN32_WINNT)
#else
...
/* To avoid setting debug macro everywhere, we simply consider
   static build to be a release build on win32. Disable debug features
   when building static library */
#ifndef Py_NO_ENABLE_SHARED

/* Check GIL thread state when operating ref count */
#define Py_DEBUG_GIL

/* Check if ref count is invalid */
#define Py_REF_DEBUG
