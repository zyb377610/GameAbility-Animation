...
class UNePyNoExportType_Box2D : public UObject
{
	...
	bool Equals(const FBox2D& Other, float Tolerance);
	...
	FBox2D ExpandBy_Overload1(float W);
...
class UNePyNoExportType_BoxSphereBounds : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FBoxSphereBounds", OriginalName = "FBoxSphereBounds"))
	void FBoxSphereBounds_Overload4(const FBox& Box);
...
class UNePyNoExportType_LinearColor : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FLinearColor", OriginalName = "FLinearColor"))
	void FLinearColor_Overload4(const FVector3f& Vector);

	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FLinearColor", OriginalName = "FLinearColor"))
	void FLinearColor_Overload6(const FVector4f& Vector);
...
class UNePyNoExportType_Math : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false))
	static int32 Max3Index(float A, float B, float C);

	UFUNCTION(meta=(bFriendFunction = false))
	static int32 Min3Index(float A, float B, float C);
	...
	static float Clamp_Overload1(float X, float Min, float Max);
	...
	UFUNCTION(meta=(bFriendFunction = false))
	static float RayPlaneIntersectionParam(const FVector& RayOrigin, const FVector& RayDirection, const FPlane& Plane);
...
class UNePyNoExportType_MotionEvent : public UNePyNoExportType_InputEvent
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FMotionEvent", OriginalName = "FMotionEvent"))
	void FMotionEvent_Overload3(FInputDeviceId InDeviceId, const FVector& InTilt, const FVector& InRotationRate, const FVector& InGravity, const FVector& InAcceleration);
...
class UNePyNoExportType_Vector : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FVector", OriginalName = "FVector"))
	void FVector_Overload4(int32 InVector);

	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "FVector", OriginalName = "FVector"))
	void FVector_Overload5(int32 A);
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "__idiv__", OriginalName = "operator/="))
	FVector __idiv___Overload1(float Scale);
	...
	FVector GetSafeNormal(float Tolerance, const FVector& ResultIfZero);

	UFUNCTION(meta=(bFriendFunction = false, CPP_Default_Tolerance = "UE_SMALL_NUMBER", CPP_Default_ResultIfZero = "ZeroVector"))
	FVector GetSafeNormal2D(float Tolerance, const FVector& ResultIfZero);
	...
	UFUNCTION(meta=(bFriendFunction = false))
	FVector RotateAngleAxisRad(float AngleRad, const FVector& Axis);
...
class UNePyNoExportType_PointerEvent : public UNePyNoExportType_InputEvent
{
	...
	public:
	UFUNCTION(meta=(bFriendFunction = false))
	void FPointerEvent(const FPointerEvent& Other, const FVector2D& InScreenSpacePosition, const FVector2D& InLastScreenSpacePosition);
...
class UNePyNoExportType_SoftObjectPath : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "AppendString", OriginalName = "AppendString"))
	void AppendString_Overload1(FString& Builder);
	...
	void SetPath_Overload3(const FString& Path);
...
class UNePyNoExportType_Vector4 : public UObject
{
	...
	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "__imul__", OriginalName = "operator*="))
	FVector4 __imul___Overload2(float Scale);

	UFUNCTION(meta=(bFriendFunction = false, ScriptName = "__idiv__", OriginalName = "operator/="))
	FVector4 __idiv___Overload2(float Scale);
